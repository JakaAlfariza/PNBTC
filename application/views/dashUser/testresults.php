...
<body>
    ...
    <div class="card mt-3">
        <div class="card-body">
            <h2 class="card-title d-flex justify-content-center mb-4">My Test Results</h2>
            <div class="container">
                <!-- Tables -->
                    ...
                    <table class="table table-hover" id="tabel-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('cuser/view_certificate/' . $data->id_hasil); ?>" class="btn btn-info">
                                        View Certificate
                                    </a>
                                </td>
                            </tr>
